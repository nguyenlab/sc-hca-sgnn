...
from models.graph_level.mlagnn import MLAGNNEncoder
...
class FunctionLevelMLAGNN(nn.Module):
    ...
    def __init__(
        ...
        # Full graph encoder with multi-level attention
        self.full_encoder = MLAGNNEncoder(
            input_dim=input_dim,
        ...
        self.sub_encoder = MLAGNNEncoder(
            input_dim=input_dim,
            hidden_dim=hidden_dim,
            num_layers=num_layers,
            num_edge_types=num_edge_types,
    ...
    def forward(
        ...
        # Dual-path encoding with multi-level attention
...
def create_function_level_mlagnn_model(
    input_dim: int = 100,
    hidden_dim: int = 256,
    num_layers: int = 3,
    num_edge_types: int = 8,
